...
const SchoolDetails = () => {
  ...
  if (error) return <div className={styles.error}>Erreur lors du chargement : {error.toString()}</div>;
  if (!school) return <div className={styles.error}>École non trouvée</div>;

  const {
    name, location, type, curriculum, images, grades,
      ...
      <div className={styles.contentContainer}>
        <div className={styles.mainContent}>
          ...
          <div className={styles.detailCard}>
            ...
            <p>
              Bienvenue à {name}, un établissement {type} situé à {location}. 
              Nous proposons le programme {curriculum} pour les classes {grades}.
            </p>
          ...
          <div className={styles.detailCard}>
            ...
            <div className={styles.detailGrid}>
              ...
              <div className={styles.detailItem}>
                ...
                <span className={styles.detailValue}>{transport ? 'Disponible' : 'Non disponible'}</span>
              </div>
              <div className={styles.detailItem}>
                <span className={styles.detailLabel}>Cantine</span>
                <span className={styles.detailValue}>{canteen?.available ? 'Disponible' : 'Non disponible'}</span>
              </div>
              <div className={styles.detailItem}>
